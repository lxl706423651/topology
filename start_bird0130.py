...
# --- 优化核心：系统负载判定参数 ---
SYSTEM_LOAD_THRESHOLD = 50.0  # 当 1分钟 Load Average 低于此值时，认为系统收敛/空闲
...
class Logger:
    def __init__(self):
        ...
        LOG_DIR = os.path.join(EXP_DIR, "bird") # 你可以自行分类
        os.makedirs(LOG_DIR, exist_ok=True)
        self.filename = os.path.join(LOG_DIR, f"bird_{timestamp}.log")
...
def main():
    ...
    time.sleep(60)  # 等待所有 BIRD 进程启动完成
